...
<template>
  <UButton :disabled="addBtnLoading" :loading="steamLoginLoading" color="neutral" variant="outline" class="w-[18rem] justify-center" icon="i-bi-steam" size="lg" @click="handleLogin">
    {{ $t('system.login') }}
  </UButton>
